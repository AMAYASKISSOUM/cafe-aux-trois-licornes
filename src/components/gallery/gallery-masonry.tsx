              ...
              {img.src ? (
                <motion.div layoutId={`gallery-photo-${img.slug}`} className="absolute inset-0">
                  <Image
                    ...
                    className="object-cover transition-transform duration-700 ease-[var(--ease-editorial)] group-hover:scale-[1.05] group-active:scale-95 group-active:duration-150"
                  />
                </motion.div>
              ) : (
